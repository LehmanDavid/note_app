...
const Notes = _i1.OperationDefinitionNode(
...
const DeleteNote = _i1.OperationDefinitionNode(
...
const AddNote = _i1.OperationDefinitionNode(
    type: _i1.OperationType.mutation,
    name: _i1.NameNode(value: 'AddNote'),
    variableDefinitions: [
      _i1.VariableDefinitionNode(
          variable: _i1.VariableNode(name: _i1.NameNode(value: 'object')),
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'notes_insert_input'), isNonNull: true),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: [])
    ],
    directives: [],
...
const document = _i1.DocumentNode(definitions: [Notes, DeleteNote, AddNote]);
